...
<head>
	...
	<meta charset="utf-8" />
	<title>Swanson Software - Software Reviews</title>
...
<div class="row">
    ...
    <section id="printable">
        ...
        <a href="index.php">SwansonSoftware Home</a> > <a href="IntroProcess.php">Process</a> > Software Reviews
        <a href="javascript:doPrint();" style="text-align:right;float:right;">Print</a>
        </span>


<h1 class="center">Software Reviews</h1>
<p>
...
<h1 class="center">Contents</h1>
    <ol class="contents">
        <li><a href="#lst1">1. Introduction</a>
            <ol class="contents">
                <li><a href="#lst1.1">1.1 Components</a></li>
                <li><a href="#lst1.2">1.2 Cost</a></li>
            </ol>
        </li>
        <li><a href="#lst2">2. Overview of Review Types</a>
			<ol class="contents">
				<li><a href="#lst2.1">2.1 Fagan's Software Review</a></li>
				<li><a href="#lst2.2">2.2 Active Design Review</a></li>
				<li><a href="#lst2.3">2.3 Two-Person Review</a></li>
				<li><a href="#lst2.4">2.4 N-Fold Review</a></li>
				<li><a href="#lst2.5">2.5 Phased Review</a></li>
				<li><a href="#lst2.6">2.6 IEEE Standard 1028 For Software Reviews</a></li>
				<li><a href="#lst2.7">2.7 Informal Reviews</a>
					<ol class="contents">
						<li><a href="#lst2.7.1">2.7.1 Walkthrough</a></li>
						<li><a href="#lst2.7.2">2.7.2 Pair Programming</a></li>
						<li><a href="#lst2.7.3">2.7.3 Peer Check</a></li>
						<li><a href="#lst2.7.4">2.7.4 Pass-Around</a></li>
					</ol>
				</li>
		 </ol>
        </li>
        <li><a href="#lst3">3. Review Process</a>
				<ol class="contents">
					<li><a href="#lst3.1">3.1 Review Task</a></li>
					<li><a href="#lst3.2">3.2 Reading Technique</a></li>
					<li><a href="#lst3.3">3.3 Planning On-going Reviews</a></li>
	         </ol>
        </li>
        <li><a href="#lst4">4. Sample Forms</a>
				<ol class="contents">
					<li><a href="#lst4.1">4.1 Technical Review Summary Report</a></li>
					<li><a href="#lst4.2">4.2 Design / Specification Grade Sheet</a></li>
	         </ol>
        </li>
...
<p>
One of the key components of a well-run software process is the software review.  The need
 for software reviews arises from fundamental inadequacies in the way software is made:
</p>
   <ul>
...
<a id="lst1.1"></a>
<h3 class="count subhead">Components</h3>
<p class="subhead">
...
<a id="lst1.2"></a>
<h3 class="count subhead">Cost</h3>
...
<a id="lst2"></a>
<h2 class="count">Overview of Review Types</h2>
...
<a id="lst2.1"></a>
<h3 class="count subhead">Fagan's Software Review</h3>
...
<!--*******************************************************************************-->
<a id="lst2.2"></a>
<h3 class="count subhead">Active Design Review</h3>
...
<!--*******************************************************************************-->
<a id="lst2.3"></a>
<h3 class="count subhead">Two-Person Review</h3>
...
<!--*******************************************************************************-->
<a id="lst2.4"></a>
<h3 class="count subhead">N-Fold Review</h3>
...
<!--*******************************************************************************-->
<a id="lst2.5"></a>
<h3 class="count subhead">Phased Review</h3>
...
<!--*******************************************************************************-->
<a id="lst2.6"></a>
<h3 class="count subhead">IEEE Standard 1028 For Software Reviews</h3>
...
<!--*******************************************************************************-->
<a id="lst2.7"></a>
<h3 class="count">Informal Reviews</h3>
<br />

<a id="lst2.7.1"></a>
<h4 class="count subhead">Walkthrough</h4>
...
<a id="lst2.7.2"></a>
<h4 class="count subhead">Pair Programming</h4>
...
<a id="lst2.7.3"></a>
<h4 class="count subhead">Peer Check</h4>
...
<a id="lst2.7.4"></a>
<h4 class="count subhead">Pass-Around</h4>
...
<a id="lst3"></a>
<h2 class="count">Review Process</h2>
...
<a id="lst3.1"></a>
<h3 class="count subhead">Review Task</h3>
<p class="subhead">
This section describes the tasks and techniques for conducting a software review, as well as 
 what to look for.
</p>
...
<a id="lst3.2"></a>
<h3 class="count subhead">Reading Technique</h3>
...
<a id="lst3.3"></a>
<h3 class="count subhead">Planning On-going Reviews</h3>
...
<a id="lst4"></a>
<h2 class="count">Sample Forms</h2>
...
<a id="lst4.1"></a>
<h3 class="count subhead">Technical Review Summary Report</h3>
<p class="subhead">
...
<a id="lst4.2"></a>
<h3 class="count subhead">Design / Specification Grade Sheet</h3>
